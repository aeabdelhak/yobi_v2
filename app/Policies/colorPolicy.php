...
class colorPolicy
{
    ...
    {
        return $user->isAdmin() || ($color->shape->landing->id_store == $user->store()->id && in_array( permissions::$landing,$user->Permissions));
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function create(User $user, color $color)
    {
        return $user->isAdmin() || ($color->shape->landing->id_store == $user->store()->id && in_array( permissions::$landing,$user->Permissions));
